...
<div class="card border-0">
    <div class="card-body">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.payments.edit', ['paymentable_type' => $paymentable_type, 'paymentable_id' => $paymentable_id, 'id' => $payment->id]) }}" class="btn btn-sm btn-secondary">Edit</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
        ...
        <a href="{{ route('admin.payments.create', ['paymentable_type' => 'booking', 'paymentable_id' => $booking->id]) }}" class="btn btn-primary btn-block">Input Pembayaran</a>
    </div>
</div>
@endsection