...
<div class="d-md-flex align-items-center justify-content-between mb-4">
  ...
  <a href="{{ route('admin.teams.create') }}" class="btn btn-primary">Tambah Data Baru</a>
</div>
            ...
            <table class="table table-borderless table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex">
                            <form action="{{ route('admin.teams.destroy', ['id' => $team->id]) }}" method="post" onsubmit = "if (! confirm('Hapus data ini?')) { return false; }">
                                @csrf
                                @method('delete')
                            ...
                            <a href="{{ route('admin.teams.edit', ['id' => $team->id]) }}" class="btn btn-sm btn-secondary ml-2">Edit</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
